[![Build Status](https://travis-ci.org/alecomputacao/travis-ci-tutorial-java.svg?branch=master)](https://travis-ci.org/joaomlneto/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/alecomputacao/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/alecomputacao/travis-ci-tutorial-java)
...
1. [Fork](https://github.com/alecomputacao/travis-ci-tutorial-java/fork) this Repository
...
- Add your repository (you can go there directly by going to https://codecov.io/gh/alecomputacao/travis-ci-tutorial-java)
...
[Open an Issue](https://github.com/alecomputacao/travis-ci-tutorial-java/issues/new)!
